...
// ---------------- globle counters ----------------
std::vector<double> g_dt_naive_seg1; // Q*Kt
std::vector<double> g_dt_naive_seg2; // row_max
std::vector<double> g_dt_naive_seg3; // exp
std::vector<double> g_dt_naive_seg4; // calculate P
std::vector<double> g_dt_naive_seg5; // P*V
                                   ...
                                   int N, int d, float scale)
{
    ...
    g_dt_naive_seg5.push_back(std::chrono::duration<double, std::milli>(t6 - t5).count());
    O[0] = tmp_c;
    return O;
}
